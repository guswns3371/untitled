...
void showmenu1()
{
    ...
    printf("\n\n\n\n\n");
    printf("\t ----------------------------------\n");
    printf("\t|      Welcome to this machine (소비자)   |\n");
    printf("\t|---------------------------------|\n");
    printf("\t|\t1-ShowAll            |\n");
    printf("\t|\t2-직접 상품 구매                |\n");
    printf("\t|\t3-Service                |\n");
...
void showmenu0()
{
    ...
    printf("\n\n\n\n\n");
    printf("\t ----------------------------------\n");
    printf("\t|      Welcome to this machine (공급업체)   |\n");
    printf("\t|---------------------------------|\n");
    printf("\t|\t1-ShowAll        |\n");
    printf("\t|\t2-Add                |\n");
    printf("\t|\t3-Revise           |\n");
...
void Buy()              //상품 구매
{
    ...
    if ((newfp = fopen("soldlist.txt", "ab")) == NULL)
    {
        printf("can not open the file\n");
        exit(0);
    }
...
void shoppingcar()
{
    ...
    char name[10];
    int loop = 1;
    if ((sfp = fopen("shoppingcar.txt", "ab")) == NULL)
    {
        printf("can not open the file");
        exit(0);
    }
...
void deletes(char name[])
{
    ...
    if ((fps = fopen("information.txt", "rb+")) == NULL)
    {
        printf("can not open the file\n");
        exit(0);
    }
    if ((dfps = fopen("delete.txt", "ab")) == NULL)
    {
        printf("can not open the file\n");
        exit(0);
    }
